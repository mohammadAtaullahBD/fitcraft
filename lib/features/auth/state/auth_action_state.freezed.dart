...
part of 'auth_action_state.dart';
...
$AuthActionStateCopyWith(AuthActionState _, $Res Function(AuthActionState) __);
}
...
class _Idle implements AuthActionState {
  const _Idle();
...
class _Loading implements AuthActionState {
  const _Loading();
...
class _Success implements AuthActionState {
...
@override
String toString() {
  return 'AuthActionState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $AuthActionStateCopyWith<$Res> {
...
class _Error implements AuthActionState {
...
@override
String toString() {
  return 'AuthActionState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $AuthActionStateCopyWith<$Res> {
